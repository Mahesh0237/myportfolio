...
function Groupdiaryinvitationswrapper({ user_uid }) {
  ...
  const getDiaryInvitations = (newPage) => {
    ...
    Diariesapi.get("getgroupdiaryinvitationdetails", {
      params: {
        user_id: user_id,
        page: newPage,
      },
                        ...
                        <tr key={index} className="truncate border-b-[0.6px] border-b-[#979797]/40 ">
                          ...
                          <td className='text-center sticky_column_last'>
                            {invitations.status === "Pending" ? (
                              ...
                              <Link href={`diary/${invitations?.name}?uid=${invitations.uuid}`}>
...
export default Groupdiaryinvitationswrapper;
