...
function Diaryinvitationmodal({ closeDiaryinvitationModal, diary_id }) {
    ...
    const handleSubmitInvitation = () => {
        ...
        Diariesapi.post('/senddiaryinvitation', {
            ...
            <Card padding='0' margin='0' className='w-[100%] max-sm:w-[100%] max-sm:rounded-none max-sm:!border-0 max-sm:shadow-none'>
                <Card.Section className='!px-4 !py-2'>
                    <div className="flex justify-between items-center">
                        <p className="text-[#044093] text-[16px] max-sm:text-[16px] md:text-xl 2xl:text-[30px]">Diary Invitation</p>
                        <Button variant="default" onClick={closeDiaryinvitationModal} className='!px-0 focus:outline-none border-none '>
...
export default Diaryinvitationmodal;
