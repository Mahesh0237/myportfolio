...
import { IconSearch, IconShare, IconX } from '@tabler/icons-react';
...
function Sharediarybylinkmodal({ closeSharediarybylinkmodal, diary_id, diary_uid, user_uid }) {
    ...
    const handleGenrateToken = () => {
        Diariesapi.post('/generatediarysharetoken', {
            ...
            <Card padding='0' margin='0' className='w-[100%] max-sm:w-[100%] max-sm:rounded-none max-sm:!border-0 max-sm:shadow-none'>
                <Card.Section className='!px-4 !py-2'>
                    <div className="flex justify-between items-center">
                        ...
                        <Button variant="default" onClick={closeSharediarybylinkmodal} className='!px-0 focus:outline-none border-none '>
...
export default Sharediarybylinkmodal;
