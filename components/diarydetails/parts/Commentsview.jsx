import { IconBrandLine, IconHeart, IconHeartFilled, IconMessage2, IconSend, } from "@tabler/icons-react";
  ...
  const submitComment = () => {
    ...
    Diariesapi.post(
      ...
      .then((res) => {
        ...
        // })
        // refreshComments()
        // the data should append as first element in the array
  ...
  async function handleSubmitLike(commentId) {
    ...
    Diariesapi.post(
      ...
      .then((res) => {
        ...
        //                 commentLikes: data.comment.commentLikes
        //             };
        //         }
        //         return comment;
        //     });
    ...
    <div className="p-3 overflow-hidden ">
      <div className="flex items-center justify-start gap-2 border-b border-[#d1d5db] pb-2">
        <div className="w-8 h-8 rounded-full overflow-hidden">
          <Image
            src={author_details?.profile_image || profilephoto}
            alt="Profile Photo"
            width={24}
            height={24}
        ...
        <p className="2xl:text-[24px]">
          {author_details?.name || "Author"}
          <span className="block text-[10px] text-[#2b2b2b]/60 2xl:text-[19px]">
            Send Message to author
          </span>
        </p>
        {
          (isLogged && parseInt(author_details?.author_id) !== parseInt(user_id)) &&
          <Button
            className="!text-[12px] !px-4 !py-2 !rounded-md ml-auto !bg-[#044093] text-white 2xl:!text-[20px]"
            onClick={() =>
              handleChatClick({
                id: author_details?.author_id, // replace with actual author id
                name: author_details?.name, // replace with actual author name
                profile_image: `${author_details?.profile_image || profilephoto.src}`, // replace with actual author image
              })
            }
          >
      ...
      <h2 className="text-[16px] font-semibold flex items-center gap-2 pb-2 pt-3 2xl:text-[24px]">
        <svg
        ...
        >
          <path
            d="M7.49249 17.585C7.04249 17.585 6.61499 17.36 6.32249 16.9625L5.42251 15.7625C5.42251 15.77 5.385 15.7475 5.37 15.7475H5.09251C2.52751 15.7475 0.9375 15.05 0.9375 11.5925V8.5925C0.9375 5.43501 2.86501 4.61001 4.48501 4.46751C4.66501 4.44501 4.87501 4.4375 5.09251 4.4375H9.8925C12.6075 4.4375 14.0475 5.87751 14.0475 8.5925V11.5925C14.0475 11.81 14.04 12.02 14.01 12.2225C13.875 13.82 13.05 15.7475 9.8925 15.7475H9.5925L8.6625 16.9625C8.37 17.36 7.9425 17.585 7.49249 17.585ZM5.09251 5.5625C4.92001 5.5625 4.755 5.57 4.5975 5.585C2.8575 5.735 2.0625 6.68751 2.0625 8.5925V11.5925C2.0625 14.165 2.85751 14.6225 5.09251 14.6225H5.3925C5.73 14.6225 6.11249 14.81 6.32249 15.08L7.2225 16.2875C7.38751 16.5125 7.5975 16.5125 7.7625 16.2875L8.6625 15.0875C8.88 14.795 9.225 14.6225 9.5925 14.6225H9.8925C11.7975 14.6225 12.75 13.82 12.8925 12.11C12.915 11.93 12.9225 11.765 12.9225 11.5925V8.5925C12.9225 6.50001 11.985 5.5625 9.8925 5.5625H5.09251Z"
            fill="#044093"
          />
          <path
            d="M7.49268 11.1425C7.07268 11.1425 6.74268 10.805 6.74268 10.3925C6.74268 9.98 7.08018 9.6425 7.49268 9.6425C7.90515 9.6425 8.24265 9.98 8.24265 10.3925C8.24265 10.805 7.91265 11.1425 7.49268 11.1425Z"
            fill="#044093"
          />
          <path
            d="M9.89246 11.1425C9.47246 11.1425 9.14246 10.805 9.14246 10.3925C9.14246 9.98 9.47996 9.6425 9.89246 9.6425C10.305 9.6425 10.6425 9.98 10.6425 10.3925C10.6425 10.805 10.305 11.1425 9.89246 11.1425Z"
            fill="#044093"
          />
          <path
            d="M5.09985 11.1425C4.67985 11.1425 4.34985 10.805 4.34985 10.3925C4.34985 9.98 4.68735 9.6425 5.09985 9.6425C5.51235 9.6425 5.84985 9.98 5.84985 10.3925C5.84985 10.805 5.51235 11.1425 5.09985 11.1425Z"
            fill="#044093"
          />
          <path
            d="M13.4551 12.7175C13.3051 12.7175 13.1551 12.6575 13.0501 12.545C12.9301 12.425 12.8776 12.2525 12.9001 12.0875C12.9226 11.93 12.9301 11.765 12.9301 11.5925V8.5925C12.9301 6.50001 11.9926 5.5625 9.90008 5.5625H5.10009C4.92759 5.5625 4.76261 5.57 4.60511 5.585C4.44011 5.6075 4.2676 5.54749 4.1476 5.43499C4.0276 5.31499 3.96009 5.15001 3.97509 4.98501C4.11009 3.36501 4.94259 1.4375 8.10008 1.4375H12.9001C15.6151 1.4375 17.0551 2.87751 17.0551 5.59251V8.5925C17.0551 11.75 15.1276 12.575 13.5076 12.7175C13.4851 12.7175 13.4701 12.7175 13.4551 12.7175ZM5.19011 4.4375H9.8925C12.6075 4.4375 14.0475 5.87751 14.0475 8.5925L14.0476 11.495C15.3226 11.18 15.9226 10.2425 15.9226 8.5925V5.59251C15.9226 3.50001 14.9851 2.5625 12.8926 2.5625H8.09258C6.44261 2.5625 5.51261 3.1625 5.19011 4.4375Z"
            fill="#044093"
          />
        </svg>{" "}
      ...
      {isLogged === false ? (
        <div className="bg-[#0440933b] mb-1 flex items-center justify-center h-[80px] w-full leading-[24px]">
          ...
          <button
            className="cursor-pointer ml-2 text-[#044093] text-[14px] font-semibold"
            onClick={() => {
              // router.push("/login");
              router.push(`/login?redirect=${encodeURIComponent(`/diarydetails/${diaryuid}`)}`)
            }}
          >
            Login
          </button>
        ...
        <>
          <div className="flex items-start gap-2 ">
            <Image
              ...
              width={24}
              height={24}
              className="rounded-full 2xl:h-12 2xl:w-12"
            />
            <div className="w-full">
              <Textarea
                ...
                rows={3}
                textareaClassName="h-[60px] !bg-[#fff] 2xl:text-[24px]"
              />
              {commentTextError && (
                <p className="text-red-500 text-[12px] mb-2 2xl:text-[20px]">
                  {commentTextError}
                </p>
              )}
            </div>
          ...
          <div className="flex">
            <button
              ...
              className={`!text-white text-[12px] !px-2 !py-1 rounded mb-6 ml-auto ${commentText
                ? "cursor-pointer bg-[#044093]"
                : "cursor-not-allowed bg-[rgba(4,64,147,0.75)]"
                } 2xl:text-[24px]`}
            >
              Post Comment
            </button>
              ...
              allComments.map((comment) => (
                <div key={comment.id} className="pb-4">
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <p className="font-semibold text-[14px] text-[#000] 2xl:text-[22px]">
                      {comment?.user_name || "N/A"}
                    </p>
                    <p className="text-gray-400 text-xs ml-auto 2xl:text-[19px]">
                      {dayjs(comment?.created_at).format("DD MMM YYYY")}
                    </p>
                  </div>
                  <p className="text-[12px] text-[#2b2b2b] mt-2 pl-8 2xl:text-[24px]">
                    {comment?.comment}
                  </p>
                  {isLogged && (
                    <div className="flex items-center gap-4 text-gray-500 text-sm pl-8 pt-2">
                      <div
                        ...
                        onClick={() => handleSubmitLike(comment.id)}
                      >
                        <div className="flex flex-row items-center gap-1">
                          {comment?.commentLikes?.length > 0 &&
                            ...
                            <IconHeartFilled className="w-4 h-4 2xl:w-6 2xl:h-6" color="red" />
                          ) : (
                            <IconHeart className="w-4 h-4 2xl:w-6 2xl:h-6" />
                          )}
                          <p className="text-[12px] text-[#2b2b2b] 2xl:text-[20px]">
                            {comment?.likeCount || 0} Likes
                          </p>
                        </div>
                      </div>
                      <button
                        className="flex items-center cursor-pointer 2xl:text-[20px]"
                        onClick={() => handleReply(comment.id)}
                      >
                        <IconBrandLine className="w-4 h-4 2xl:w-6 2xl:h-6" /> Reply
                      </button>
                    </div>
                  )}
                  {/* Replies Section */}
                    ...
                    <div className="w-full p-2 bg-white rounded-sm shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] border border-gray-200">
                      ...
                      >
                        <div className="basis-[90%]">
                          <Textarea
                            placeholder="Reply..."
                            className={`!border !rounded-[2px] text-[12px] !bg-[#fff] ${replyTextError
                              ? "border-red-500"
                              : "border-[#d1d5db]"
                              }`}
                            value={replyText}
                            ...
                            rows={2}
                            textareaClassName="h-[40px] !bg-[#fff] 2xl:!text-[24px]"
                          />
                        </div>
                        <div className="basis-[10%]">
                          <button
                            ...
                            className={`!text-white text-[12px] !px-2 !py-1 rounded ml-auto ${replyText
                              ? "cursor-pointer bg-[#044093]"
                              : "cursor-not-allowed bg-[rgba(4,64,147,0.75)]"
                              }`}
                          >
                            <IconSend className="h-4 w-4 2xl:h-6 2xl:w-6" />
                          </button>
                        </div>
                      </div>
                    </div>
