...
function Addnewuser({ closeAddnewmodal, refreshUserData, roles, countryCodes }) {
            ...
            <Card withBorder={false} padding='0px'>
                <Card.Section className='!px-0 !pt-0'>
                    <div className="flex justify-between items-center">
                        {/* Title */}
                        <p className="text-[#044093] text-xl md:text-xl max-sm:text-[17px]">Add New User</p>
                        <Button onClick={closeAddnewmodal} variant="transparent" size="xs" color="#000">
                            <IconX size={20} color='#044093' />
                        </Button>
                    </div>
                </Card.Section>
                <Card.Section withBorder className='!px-0 !border-b-0 !pb-0'>
                    ...
                    <Button onClick={handleSubmit} disabled={isLoadingEffect}
                        className="!flex justify-end !px-3 !mt-3 !ml-auto !text-[14px] !bg-[#044093] !text-white !py-2">
                        Add User
                    </Button>
                </Card.Section>
            </Card>
