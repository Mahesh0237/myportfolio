        ...
        <div className="relative">
            <div className="rounded-lg shadow-sm  bg-white">
                ...
                <div className="flex justify-between items-center border-b border-b-gray-300 pb-2">
                    <p className="text-sm font-bold text-[#044093]">Edit Role</p>
                    <button
               ...
               <div className="pt-2 flex justify-end">
                    <button
                        ...
                        disabled={isLoading}
                        className="px-4 py-2 text-white cursor-pointer bg-[#044093] border border-gray-800 rounded hover:bg-gray-700 disabled:opacity-50 text-xs"
                    >
                        Update Role
                    </button>
                </div>
