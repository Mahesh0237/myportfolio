...
import { Textinput, Passwordinput, Button, Select, Card, Loadingoverlay } from '@nayeshdaggula/tailify';
            ...
            <Card padding='0' margin='0' className='w-[100%] max-sm:w-[100%] max-sm:rounded-none max-sm:!border-0 max-sm:shadow-none'>
                <Card.Section className='!px-4'>
                    <div className="flex justify-between items-center">
                        {/* Title */}
                        <p className="text-[#044093] text-xl md:text-xl max-sm:text-[17px]">Add New Employee</p>
                        <Button variant="default" onClick={closeAddnewmodal} className='!px-0 focus:outline-none border-none '>
